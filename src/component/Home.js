                ...
                <div class="flex flex-wrap -m-12">
                    {
                        blogs.map(blog => (
                            ...
                            <div class="p-12 md:w-1/2 flex flex-col items-start">
                                <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">{blog.category}</span>
                                <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4 w-auto">{blog.title}</h2>
                                <p class="leading-relaxed mb-8">{blog.summary}</p>
                                <div class="flex items-center flex-wrap pb-4 mb-4 border-b-2 border-gray-100 mt-auto w-full">
                                    <Link class="text-indigo-500 inline-flex items-center" to={`/blog/${blog.slug}`}>Read more
                                ...
                                <a class="inline-flex items-center">
                                    <img alt="blog" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSFWBnyvJtrWYVL5q2Nwl1UkCOxOPxFGoORjg&usqp=CAU" class="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center" />
                                    <span class="flex-grow flex flex-col pl-4">
                                        <span class="title-font font-medium text-gray-900">Sarosh</span>
                                        <span class="text-gray-400 text-xs tracking-widest mt-0.5">Writer</span>
                                    </span>
                                </a>
                            </div>
                        )
